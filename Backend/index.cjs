...
app.get("/loginuser", function (req, res) {
  ...
  scope =
    "user-read-private user-read-email user-library-read user-library-modify playlist-modify-public playlist-modify-private playlist-read-private playlist-read-collaborative";
...
app.get(
  ...
  async (req, res) => {
    ...
    if (!response.ok) {
      return res
        .status(500)
        .json({ error: "Failed to refresh token", details: data });
    }
